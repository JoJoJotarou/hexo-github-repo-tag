    ...
    return github.repo(args[0]).then(function (resp) {
        ...
        return `<style>
                ...
                .card {
                    ...
                    --header-width-proportion: 10%;
                    --footer-width-proportion: 10%;
                    --content-width-proportion: 80%;

                    --header-min-width: 80px;
                    --footer-min-width: 80px;

                    --card-element-margin: 6px 10px 6px 10px; /* header content footer*/
                ...
                .header {
                    width: var(--header-width-proportion);
                    min-width: var(--header-min-width);
                    margin: var(--card-element-margin);
                    background-color: #fff;
                ...
                .content {
                    width: var(--content-width-proportion);
                    margin: var(--card-element-margin);
                    background-color: #fff;
                }
                ...
                .footer {
                    width: var(--footer-width-proportion);
                ...
                <div class="card">
                    ...
                    <div class="content">
                        <div class="fullname"><h5><i class="fa fa-github fa-lg" aria-hidden="true"></i> ${data.full_name}</h5></div>
                        <div class="description">
                            ${data.description}
                        </div>
                    </div>
                    <div class="footer">
                        <div class="language-star">
                            <div><span class="language">${data.language}</span></div>
                            <div><i class="fa fa-star-o" aria-hidden="true" id='star'> ${unit(data.stargazers_count)}</i></div>
                        </div>
                        <div class="card-toolbar">
                            <div class="repo-link">
                                <a href="${data.html_url}" target="_blank" rel="noopener noreferrer"
                                    title="Open in a new TAB">
                                    <i class="fa fa-external-link-square fa-lg" aria-hidden="true" style="color: black;"></i>
                                </a>
                            </div>
                        </div>
                    </div>
